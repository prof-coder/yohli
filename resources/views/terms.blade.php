...
<div class="bg-light-custom max py-16 px-8">
    <div class="max-w-4xl mx-auto ">
        ...
        The Terms and Conditions which you accept by using our Website or our Services. We have incorporated by reference some linked information.
<ul>
 	<li><strong>"Account"</strong>means the account associated with your email address.</li>
 	<li><strong>"Buyer"</strong>means a User that purchases Seller Services or items from Sellers or identifies a Seller through the Website. A User may be both a Buyer and a Seller under this agreement.</li>
 	<li><strong>"Contest"</strong>means a contest that is promoted by a Buyer and in respect of which a Seller can submit one or more entries via the Website.</li>
 	<li><strong>"Contest Brief"</strong>means the document setting out the scope of a Contest, including but not limited to items such as a design brief.</li>
 	<li><strong>"Contest Handover"</strong>, in respect of a Contest, means the agreement between the Buyer and one or more winning Seller(s) under which each Seller will transfer to the Buyer ownership of the winning entry or entries.</li>
 	<li><strong>"Dispute Resolution Process"</strong>means the process to be followed by Buyers and Sellers in accordance with the Dispute Resolution Services.</li>
 	<li><strong>"Entrant"</strong>means a Seller who has entered a Contest.</li>
 	<li><strong>"Yohli"</strong>, <strong>"we"</strong>, <strong>"our"</strong>, <strong>"company"</strong>or <strong>"the company"</strong> or <strong>"us"</strong> means Yohli LLC.</li>
 	<li><strong>"Yohli Verified"</strong>Users have been satisfactorily verified under the Know your Customer and Identity Verification Policy.</li>
 	<li><strong>"Inactive Account"</strong>means a User Account that has not been logged into for a 6-month period, or other period determined by us from time to time.</li>
 	<li><strong>"Intellectual Property Rights"</strong>means any and all intellectual property rights, existing worldwide and the subject matter of such rights, including: (a) patents, copyright, rights in circuit layouts (or similar rights), registered designs, registered and unregistered trademarks, and any right to have confidential information kept confidential; and (b) any application or right to apply for registration of any of the rights referred to in paragraph (a), whether or not such rights are registered or capable of being registered and whether existing under any laws, at common law or in equity.</li>
 	<li><strong>"Local Job"</strong>or <strong>"Local Jobs"</strong> means a service we provide to match a Buyer with a Seller in relation to the provision of location specific services.</li>
 	<li><strong>"Milestone Payment"</strong>means a payment made by the Buyer for the provision of Seller Services under a User Contract and which will be released in accordance with the section "Milestone Payments" of these terms and conditions.</li>
 	...
 	<li><strong>"Seller"</strong>means a User that offers and provides services or identifies as a Seller through the Website. A User may be both a Buyer and a Seller under this agreement.</li>
 	<li><strong>"Seller Services"</strong>means all services provided by a Seller.</li>
 	<li><strong>"Yohli Services"</strong>means all services provided by us to you.</li>
 	<li><strong>"User"</strong>, <strong>"you"</strong>or <strong>"your"</strong> means an individual who visits or uses the Website, including via the API.</li>
 	<li><strong>"User Contract"</strong>means: (1) this User Agreement; (2) the Code of Conduct as amended from time to time; (3) any other contractual provisions accepted by both the Seller and Buyer uploaded to the Website, to the extent not inconsistent with the User Agreement and the Code of Conduct; (4) the Project terms as awarded and accepted on the Website, to the extent not inconsistent with the User Agreement and the Code of Conduct; and (5) any other material incorporated by reference from time to time.</li>
 	<li><strong>"Website"</strong>means the Websites operated by Yohli and available at: <a href="https://yohli.com/">com</a> and any of its regional or other domains or properties, and any related Yohli service, tool or application, specifically including mobile web, any iOS App and any Android App, or API or other access mechanism.</li>
</ul>
<ol>
 	<li><strong> Overview</strong></li>
</ol>
By accessing the Website, you agree to the following terms with Yohli.
...
<ol>
 	...
 	<li>a person barred from receiving and rendering services under the laws of Ghana or other applicable jurisdiction;</li>
...
<ol start="4">
 	<li><strong> Using Yohli</strong></li>
</ol>
...
<ol>
 	...
 	<li>circumvent or manipulate our fee structure, the billing process, or fees owed to Yohli;</li>
 	...
 	<li>transfer your Yohli account (including feedback) and Username to another party without our consent;</li>
 	<li>distribute or post spam, unsolicited, or bulk electronic communications, chain letters, or pyramid schemes;</li>
 	<li>distribute viruses or any other technologies that may harm Yohli, the Website, or the interests or property of Yohli users (including their Intellectual Property Rights, privacy and publicity rights) or is unlawful, threatening, abusive, defamatory, invasive of privacy, vulgar, obscene, profane or which may harass or cause distress or inconvenience to, or incite hatred of, any person;</li>
 	...
 	<li>copy, modify or distribute rights or content from the Website or Yohli's copyrights and trademarks; or</li>
 	<li>harvest or otherwise collect information about Users, including email addresses, without their consent.</li>
 	<li>use Yohli to facilitate money exchange including, but not limited to, cryptocurrency (e.g. bitcoin, ethereum, etc).</li>
 	<li><strong> Intellectual Property Rights Infringement</strong></li>
</ol>
...
<strong>0% Fees Promotion</strong>

Project commissions charged for Sellers who refer new Buyers that do not have an existing account on Yohli and who join and create a new account, will be reduced from 10% to 0%, for all future Projects performed by the referring Seller ("Referrer") for the referred Buyer ("Referee").

This is subject to the following conditions:
<ol>
 	<li>Referees must be referred using the specific promotional links on <a href="https://www.yohli.com/no-commission">https://www.yohli.com/no-commission</a></li>
 	<li>For the avoidance of doubt, the reduced Project commission of 0% applies only in relation to new work performed by the Referrer who has successfully applied for this promotion for the specific Referee to whom the application relates. The new Projects must commence after the Buyer creates a new account on Yohli and be initiated using that new account.</li>
 	<li>Project commission fees for the freelancer only are lowered from 10% to 0% under this promotion. All other fees and charges remain unaffected including but not limited to Buyer commissions and transaction fees.</li>
 	<li>This promotion does not apply to Contests.</li>
 	<li>Yohli reserves the right to review classifications of Referee as new Buyers for the purpose of this promotion, to ensure fair use of this promotion. The Referee must have worked with, and paid, the Referrer applying to use this promotion before the beginning of this promotion, for example from another platform. The Referrer s may be required to provide evidence of this prior work and payment before being eligible for the commission reduction. To be eligible for this promotion, The Referee must not have had any account on Yohli prior to creating the new account.</li>
 	<li>All other elements of the User Agreement continue to apply - see <a href="https://www.yohli.com/about/terms">https://www.yohli.com/about/terms</a>.</li>
 	<li>All other elements of the Fees and Charges component of the Additional Terms continue to apply - see <a href="https://www.yohli.com/feesandcharges">https://www.yohli.com/feesandcharges</a>.</li>
 	<li>Yohli may require that both parties fill in and complete their profiles and/or pass identity checks before payments are released.</li>
 	<li>Yohli may require that the details for any Project for which the commission reduction applies are appropriately complete.</li>
 	<li>This promotion may be withdrawn for a specific user, if significant reversals, fraud or chargebacks are observed, if Yohli believes that there is a risk of funds being subject to reversal or chargeback, in cases of disputes between Referee and the Referrer, or for any other reason.</li>
 	<li>Yohli reserves the right to disallow use of this promotion in its sole and absolute discretion, with respect to fair use of this promotion, and to prevent any suspected fraud.</li>
 	<li>Yohli reserves the right to require submission of further information from any party applying to make use of this promotion, for investigating fraud and for risk management and related purposes.</li>
 	<li>Yohli reserves the right to cancel or amend this promotion at any time.</li>
 	<li>Yohli reserves the right to cancel the promotion in any region if it is deemed or becomes unlawful to offer the promotion to any resident of that region.</li>
 	<li>Yohli reserves the right to recover the fees from any users participating in the 0% program should it discover at any time that the users were found not to be acting in good faith</li>
</ol>
<strong>Referral Program</strong>

For a limited promotional period, Yohli will provide site credits or reduced fees limited to certain users as a reward for referrals of new Buyer users. The promotion is based on existing users of the website ("Referrers") referring new Buyer users ("Referees") with the intention to post their first job. In some cases, the credit may be given in the form of coupon links or codes, where the Referrer in that case is the website itself.

This is subject to the following conditions:
<ol>
 	<li>The Referrer must be an existing user of the Website.</li>
 	<li>All members of the program, referrer and referees are subject to all other terms and conditions of the website, which in case of dispute, are held above this section.</li>
 	<li>All members of the program must be over the age of 18 years.</li>
 	<li>Referees must be referred using the specific promotional links on <a href="https://www.yohli.com/give">https://www.yohli.com/give</a>or <a href="https://www.yohli.com/no-commission">https://www.yohli.com/no-commission</a> or via links in email or other promotional correspondence specific to this promotion.</li>
 	<li>Users may be asked to provide verification of payment or other user information before receiving the credit.</li>
 	<li>Any site credit that has been given in relation to this promotion may expire at any time determined by the Company.</li>
 	<li>Referrers will receive credit when the relevant matching Referee user fully releases a minimum of &lt;insert dollar amount&gt; worth of milestone payments with respect to a new Project, or awards the prize with respect to a new Contest.</li>
 	<li>This site credit may only be used for the purpose of establishing a milestone payment, funding a prize for a new Contest, or payment of site Project or Contest fees.</li>
 	<li>Yohli reserves the right to review classifications of Referees as new Buyers for the purpose of this promotion, to ensure fair use of this promotion. To be eligible for this promotion, Referees must not have had any active account on Yohli from which a payment was made within the six (6) months immediately prior to creating the new account.</li>
 	<li>Yohli may require that both parties fill in and complete their profiles and/or pass identity checks before payments are released.</li>
 	<li>This promotion may be withdrawn for a specific Yohli believes that there is a risk of funds being subject to reversal or chargeback, in cases of disputes between Referee and Referrer, or for any other reason.</li>
 	<li>For any specific Referrer user, Yohli may choose to cap the maximum value of site credit accrued by an individual or collection of users.</li>
 	<li>Yohli reserves the right to disallow use of this promotion in its sole and absolute discretion, with respect to fair use of this promotion, or to prevent any suspected fraud.</li>
 	<li>Yohli reserves the right to require submission of further information from any party applying to make use of this promotion, for investigating fraud and for risk management and related purposes, in particular to request evidence of bona fide work being done in relation to any Project or Contest funded with the site credit.</li>
 	<li>Yohli reserves the right to cancel or amend this promotion at any time.</li>
 	<li>Yohli reserves the right to cancel the promotion in any region if it is deemed or becomes unlawful to offer the promotion to any resident of that region.</li>
 	<li>Yohli reserves the right to cap the total site credit available under the program.</li>
 	<li>Any site credit may not be duplicated, sold, traded or transferred in any manner, including but not limited to being withdrawn for cash.</li>
 	<li>Yohli reserves the right to reverse credit earned if it determines that the referrers or referees are not acting as users of the site in good faith.</li>
 	<li>Referrals should have unique payment sources in order to qualify the parent for the referral credit.</li>
 	<li>Bonus credit is only reserved for referring users who act at all times in good faith and who signed up to the site with actual intent of using the website for its intended purposes.</li>
 	<li>Yohli reserves the right to remove credit or remove users from participating in the program if the company determines the users to be acting in bad faith and are abusing the program.</li>
 	<li>The decisions of management are final. No correspondence will be entered into.</li>
 	<li>Management, employees of Yohli and its related companies are not eligible to participate in this program.</li>
 	<li>Any term or condition in these terms found to be void, unenforceable or illegal may be severed and the remaining terms and conditions will continue in full force and effect.</li>
 	<li>Yohli reserves the right to set the bonus credits for each individual referrer and individual referral users and to release said bonus credit in any currency the company sees fit.</li>
 	<li>Yohli is not liable for any loss or damage whatsoever which is suffered (including but not limited to, direct or consequential loss) or for any personal injury suffered or sustained in connection with entry into the competition or acceptance of the prize.</li>
</ol>
<strong>Credit Promotions</strong>
...
From time to time, Yohli may provide site credits (for example US$20 off your next project) limited to certain users as a promotion. In these cases, the credit may be given in the form of coupon links or codes, emails, sms or advertisements.

This is subject to the following conditions:
<ol>
 	<li>All members of the program are subject to all other terms and conditions of the website, which in case of dispute, this section will prevail over.</li>
 	<li>All members of the program must be over the age of 16 years.</li>
 	<li>Users may be asked to provide verification of payment or other user information before receiving the credit.</li>
 	<li>Any site credit that has been given in relation to this promotion may expire at any time determined by the Company.</li>
 	<li>Any site credit will expire no longer than 30 days unless otherwise written on the promotion.</li>
 	<li>This site credit may only be used for the purpose of establishing a milestone payment, funding a prize for a new Contest, or payment of site fees including but not limited to project fees, contest fees, upgrades and memberships.</li>
 	<li>Yohli may require that redeeming users fill in and complete their profiles and/or pass identity checks before payments are released.</li>
 	<li>This promotion may be withdrawn for a specific user or set of users, if significant reversals, fraud or chargebacks are observed, if Yohli believes that there is a risk of funds being subject to reversal or chargeback, in cases of disputes, or for any other reason.</li>
 	<li>For any specific user, Yohli may choose to cap the maximum value of site credit accrued by an individual or collection of related individuals.</li>
 	<li>For avoidance of any doubt, no individual or collection of related individuals may accumulate more than US$5,000 of site credit.</li>
 	<li>Yohli reserves the right to disallow use of this promotion in its sole and absolute discretion, with respect to fair use of this promotion, or to prevent any suspected fraud.</li>
 	<li>Yohli reserves the right to require submission of further information from any party applying to make use of this promotion, for investigating fraud and for risk management and related purposes, in particular to request evidence of bona fide work being done in relation to any Project or Contest funded with the site credit.</li>
 	<li>Yohli reserves the right to cancel or amend this promotion at any time.</li>
 	<li>Yohli reserves the right to cancel the promotion in any region if it is deemed or becomes unlawful to offer the promotion to any resident of that region.</li>
 	<li>Yohli reserves the right to cap the total site credit available under the program.</li>
 	<li>For avoidance of any doubt, the total site credit available under any program is capped to US$20,000.</li>
 	<li>Any site credit may not be duplicated, sold, traded or transferred in any manner, including but not limited to being withdrawn for cash.</li>
 	<li>Yohli reserves the right to remove credit or remove users from participating in the program if the company determines the users to be acting in bad faith and are abusing the program.</li>
 	<li>The decisions of management are final. No correspondence will be entered into.</li>
 	<li>Management, employees of Yohli and its related companies are not eligible to participate in this program.</li>
 	<li>Any term or condition in these terms found to be void, unenforceable or illegal may be severed and the remaining terms and conditions will continue in full force and effect.</li>
 	<li>Yohli reserves the right to set the bonus credits for each individual user and to release said bonus credit in any currency the company sees fit.</li>
 	<li>Yohli is not liable for any loss or damage whatsoever which is suffered (including but not limited to, direct or consequential loss) or for any personal injury suffered or sustained in connection with entry into the competition or acceptance of the prize.</li>
...
<strong>For Indian Seller on Yohli only:</strong> As of 1st of October 2018 Indian GST laws mandate a collection of 1% GST by Yohli.com as tax on the net value of taxable supplies made by the Seller through the web portal of Yohli. Accordingly, Yohli shall collect a 1% tax from the net value of the taxable projects or listings made by the Buyer and will deposit the same to the Indian government exchequer in accordance with applicable GST laws. In cases where (i) the Seller is outside India and (ii) GST is payable by the Buyer under reverse charge basis, Yohli is not required to collect this tax.
<ol start="8">
 	<li><strong> Payment Administration Agent</strong></li>
</ol>
...
We may display your company or business name, logo, images or other media as part of the Yohli Services and/or other marketing materials relating to the Website, except where you have explicitly requested that we do not do this and we have agreed to such a request in writing.
...
You acknowledge and agree that we may transfer your personal information to a related body corporate and your information may be transferred outside of Ghana. If you wish to withdraw your consent, you acknowledge and agree that we may be unable to provide you with access to the Website and Yohli Services and may close your Account.
...
<ol start="11">
 	<li><strong> Feedback, Reputation and Reviews</strong></li>
</ol>
...
Yohli may use information such as your name, location, display or username, and or your image, in relation to the provision messaging services on the Website or in the mobile apps.
...
<ol start="14">
 	<li><strong> Identity / Know Your Customer</strong></li>
</ol>
...
We reserve the right to close, suspend, or limit access to your Account, the Website and/or Yohli Services in the event we are unable to obtain or verify to our satisfaction the information which we request under this section.
...
If you are not Yohli Verified you may not be able to withdraw funds from your Yohli Account, and other restrictions may apply. See the Know Your Customer and Identity Verification Policy for more details.
<ol start="15">
 	<li><strong> User Services</strong></li>
</ol>
...
Each User acknowledges and agrees that the relationship between Buyers and Sellers is that of an independent contractor. Nothing in this User Agreement creates a partnership, joint venture, agency or employment relationship between Users. Nothing in this User Agreement shall in any way be construed as forming a joint venture, partnership or an employer-employee relationship between Yohli and any User.
<ol start="16">
 	<li><strong> Special Provisions for Local Jobs</strong></li>
</ol>
Each User acknowledges:
<ol>
 	<li>Yohli does not review, approve, recommend or verify any of the credentials, licences or statements of capability in relation to Local Jobs (or, for the avoidance of doubt, any non Local Jobs on the Website);</li>
 	<li>Yohli provides matchmaking and platform services only. Users agree that Yohli has no liability for any other aspect of service delivery or interaction between Buyer and Seller. Yohli is not a party to any disputes between Buyer and Seller, although we provide a dispute resolution mechanism to assist the parties in resolving issues;</li>
 	<li>Yohli may from time to time include map features and Yohli may display the location of Users to persons browsing the Website on that map. Every Buyer seeking services for Local Jobs will be asked to provide the location where the Local Job is to be performed. You expressly agree that Yohli has no liability for displaying such information.</li>
 	...
 	<li>Yohli may collect location related data from you via technologies including but not limited to GPS, IP address location, Wi-Fi, and by other methods. This data may be shared in the context of facilitating services for Local Jobs and each User specifically consents to this collection and sharing as part of this agreement;</li>
 	<li>Upon completion of a Local Job Project, Seller User must log on to the Website and click the "Complete" button for that Local Job, as soon as practicable.</li>
 	<li>Failure to complete the service or task will constitute a breach of this User Agreement; and</li>
 	<li>Our fees are applied to the amount of the awarded Seller's bid to perform the services for the Local Job. Any items purchased by the Seller as part of performing the service are between the Buyer and Seller.</li>
...
<ol>
 	<li>set-off the negative amount with funds that you subsequently receive into your Account;</li>
 	<li>if you have funds in multiple currencies in your Account and one of the currencies becomes negative for any reason, we may set-off the negative amount against funds you maintain in a different currency (at an exchange rate applied by us);</li>
 	<li>reverse payments you have made from your Account to other User Accounts on the Website;</li>
 	<li>deduct amounts you owe us from money you subsequently add or receive into your Account; or</li>
 	<li>immediately suspend or limit your Account until such time as your Account no longer has a negative amount.</li>
</ol>
...
<ol>
 	<li>we are not a bank or other licensed financial institution and do not provide banking services or any financial services to you;</li>
 	<li>the funds shown in your Account (which may include Milestone Payments subject to Section 25, and/or any prepayment of fees and charges which you owe to us) represents our unsecured obligations to you with respect to your rights to direct us to make payment in relation to the purchase and sale of Seller Services through the Website and provision of the Yohli Services;</li>
 	<li>if you were a User acquired in an acquisition and your account was migrated to the Website, we are responsible for your positive funds only to the extent of the legal documentation between us and any acquired marketplace, along with this agreement, and you acknowledge specifically that the onus is on you to confirm the validity of your fund, and that any understatement or misstatement in relation to this is not a claim against us, and belongs with the counterparty of any prior user agreement to which you agreed;</li>
 	<li>to the extent that we are required to release funds from your Account to you, you will become our unsecured creditor until such funds are paid to you;</li>
 	<li>we are not acting as a trustee or fiduciary with respect to such funds or payments;</li>
 	<li>the amount of funds showing in your Account is not insured and is not a guaranteed deposit;</li>
 	<li>funds may only load into your Account, or released from your Account, by us and you must only use the mechanisms available on the Website to pay for, or receive funds in respect of Seller Services;</li>
 	<li>any refunds required to be processed in your favor will be returned only to the source of the original deposit, and cannot be redirected to any other payment source;</li>
 	<li>we will hold funds in respect of the amount of your Account (including Milestone Payments, subject to Section 25) in an account held by us with a financial institution (or in any manner that we decide in our sole discretion from time to time) and such funds are not segregated into a separate account; and</li>
 	<li>we may commingle your funds with funds of other Users and our own funds and such commingled funds could be used to pay other Users or for our general corporate purposes or otherwise, however, we will remain obliged to release or refund funds at your direction in accordance with this User Agreement.</li>
 	<li><strong> Limits &amp; Fraud Prevention</strong></li>
</ol>
...
You can request a refund by using our customer support website or emailing us at Yohli <a href="mailto:support@yohli.com">support@yohli.com</a>. Once you have made a Milestone Payment subject to Section 25, you expressly agree to use the dispute resolution process in this agreement, expressly agree to be bound by its ruling and expressly agree not to initiate any chargeback request with your card issuer.
...
We may require you to be Youli Verified before you can withdraw funds from your Yohli Account, irrespective of whether or not a delay has been enforced. For details of how to become Yohli Verified please read the Know your Customer and Identity Verification Policy.
...
<ol start="21">
 	<li><strong> Chargebacks</strong></li>
</ol>
...
<ol start="23">
 	<li><strong> Right to Refuse Service</strong></li>
</ol>
...
<ol>
 	...
 	<li>you are the subject of a United Nations, Australian, EU, USA or other applicable sanctions regime, or our banking and payment relationships otherwise preclude us from conducting business with you;</li>
...
<ol start="24">
 	<li><strong> Milestone Payments</strong></li>
</ol>
Subject to Section 25, we do not operate an escrow service in relation to the Website. Yohli separately owns and operates a business known as Escrow.com - for the avoidance of doubt this business is separate and there is no connection between terms, conditions, products and services offered on Yohli and services offered on Escrow.com. We do, however, provide a service on this Website which allows controlled payments to be made with respect to a service, called Milestone Payments.
...
<ol>
 	<li>the Buyer and Seller agree that the funds can be claimed by the Seller;</li>
 	<li>if there is a dispute, the Buyer and Seller have concluded the Dispute Resolution Process and the Dispute is resolved in the Seller's favor;</li>
 	<li>the Buyer instructs us to pay a Seller for services performed by the Seller in respect of a Project or Contest; or</li>
 	<li>the Buyer acknowledges that the Seller has completed the services fully and satisfactory.</li>
</ol>
...
<ol start="25">
 	<li><strong> Requirements for Californian Users and Milestone Payments</strong></li>
</ol>
...
The Escrow.com Group includes Escrow.com Inc. and Internet Escrow Services, Inc (“IES”) which are owned and operated by a wholly owned subsidiary in the Yohli Group. IES is a licensed Escrow Agent in the state of California holding Escrow Agent License No. 9631867, issued by the California Department of Business Oversight. As part of using the Escrow.com service you authorize Yohli to share your information with the Escrow.com Group to complete Escrow.com’s identity verification and know your customer procedures.

On completion of the work related to the Milestone Payment, the Seller will direct IES to disburse the proceeds of the Escrow.com Transaction to the User’s Account with Yohli.

&nbsp;

<strong>MIGHT REMOVE THE BELOW: </strong>

<strong>Accepted Currencies for Milestone Payments and California Users</strong>

Escrow.com currently supports Transactions in three currencies; U.S. Dollars, Ghana Cedis and Canadian Dollars (“Supported Currencies”). If a Buyer's Payment Method is denominated in a currency other than the supported currencies, a currency conversion will be required for the Milestone Payment to be made and an Escrow.com Transaction to proceed. We will display foreign currency conversion rates that Yohli, Escrow, or our Affiliates currently make available to convert supported foreign currencies to one of the Supported Currencies.

These foreign currency conversion rates adjust regularly based on market conditions. Wholesale currency conversion rates at which Yohli or our Affiliates obtain foreign currency will usually be different than the foreign currency conversion rates offered on the Site. Each User, in its sole discretion and risk, may authorize the charge, debit, or credit of its Payment Method in a supported foreign currency and the conversion of the payment to one of the supported currencies at the foreign currency conversion rate displayed on the Site. A list of supported foreign currencies is available on the Site. If foreign currency conversion is required to make a payment in one of the Supported Currencies and either Yohli, Escrow, or our Affiliates does not support the foreign currency or the User does not authorize the conversion of such payment at the foreign currency conversion rate displayed on the Site, Escrow or one of our Affiliates will charge, debit, or credit the User's Payment Method and the User's Payment Method provider will convert the payment at a foreign currency conversion rate selected by the User's Payment Method provider. The User's Payment Method provider may also charge fees directly to the Payment Method even when no currency conversion is involved. The User's authorization of a payment using a foreign currency conversion rate displayed on the Site is at the User's sole risk. Yohli, Escrow, and our Affiliates are not responsible for currency fluctuations that occur when billing or crediting a Payment Method denominated in a currency other than one of the Supported Currencies. Yohli, Escrow, and our Affiliates are not responsible for currency fluctuations that occur when receiving or sending payments to and from the Escrow Account.

<strong>Release and Delivery of Amounts in Escrow</strong>

Buyers and Sellers in a California Transaction irrevocably authorize and instruct IES to release applicable portions of the Milestone Payment in an Escrow Account (each portion, a “Release”) to their Seller Escrow Account or in the event of a refund, the Buyer Escrow Account, as applicable, upon the occurrence of and in accordance with one or more Release Conditions provided below or as otherwise required by applicable law or the Terms of Service. The amount of any Release will be delivered to the applicable Yohli Account in accordance with Seller’s or Buyer’s authorization, as above, these Instructions, and the IES Terms of Service and General Escrow Instructions.

As used in these Instructions, “Release Condition” means any of the following:
<ol>
 	<li>Buyer clicks to release funds to Seller.</li>
 	<li>Buyer does not take any action for 14 days from the date of a Seller’s Release request, in which case Seller and Buyer agree that IES is authorized and irrevocably instructed to immediately release to Seller the amount associated in the applicable milestone in connection with such Release request.</li>
 	...
 	<li>Buyer and Seller have submitted joint written instructions for a Release to either Seller Escrow Account or Buyer Escrow Account, as applicable.</li>
 	...
 	<li>Buyer or Seller has failed to make its Arbitration payment or paid its fair share of the Arbitration costs pursuant to the Dispute Resolution Service, in which case the funds are released to the Party that has made its Arbitration Payment.</li>
 	<li>Both Buyer and Seller have failed to timely submit to Arbitration for an unresolved Dispute as such term is defined in the Dispute Resolution Service, in which case the funds are released to the Buyer.</li>
 	<li>Buyer or Seller has failed timely to respond to a Yohli Dispute Resolution Service notification as required by the Dispute Resolution Service, in which case the funds are released to the User that has participated.</li>
 	<li>Buyer or Seller otherwise has failed to comply with the Dispute Resolution Service, in which case the funds are to be released to the User that has complied with the Dispute Resolution Service.</li>
 	<li>Submittal of a final award of an arbitrator appointed pursuant to the Dispute Resolution Service, in which case the funds will be released in accordance with such award.</li>
 	...
 	<li>Yohli believes, in our sole discretion, that fraud, non-payment, illegal act, or a violation of Yohli’s <a href="https://www.freelancer.com/about/terms">User Agreement</a>has been committed or is being committed or attempted, in which case Buyer and Seller irrevocably authorize and instruct IES to take such actions as Yohli deems appropriate in our sole discretion and in accordance with applicable law, in order to prevent or remedy such acts, including without limitation to return the funds associated with such acts to their source of payment.</li>
 	<li><strong> Milestone Dispute Resolution Services</strong></li>
</ol>
Yohli offers Milestone Dispute Resolution Services to Users who have elected to use the Milestone Payment feature. You agree and acknowledge that: (i) Yohli is not providing legal services; (ii) Yohli will not advise you regarding any legal matters; and (iii) if you desire to have legal counsel, you will seek an independent legal counsel from those licensed to practice law in your jurisdiction. You will not rely on Yohli for any such counsel.

In the event of a dispute between a Buyer and a Seller regarding a return or release of Milestone Payments, either Buyer or Seller may elect to use the Milestone Dispute Resolution Services offered by Yohli as set out in the Milestone Disputes Policy. The Buyer and Seller will then be notified that the matter will be addressed through Milestone Dispute Resolution Services.

You agree to indemnify and (to the maximum extent permitted by law) hold Yohli and any of our affiliates harmless against any damages or liability you may suffer as a result of using the Milestone Payments and/or Milestone Dispute Resolution Services.

Yohli will respond to disputes initiated by a Seller or a Buyer in accordance with the Milestone Dispute Resolution Services as set out in this clause and the Milestone Disputes Policy and in relation to disputes that arise in relation to the provision of the venue, and the hosting of the Website by Yohli as set out in the clause entitled Disputes with Us, along with the approach to disclosing information in relation to chargebacks set out in clauses 19 and 21 of this agreement.
<ol start="27">
 	<li><strong> Other Disputes With Users</strong></li>
</ol>
...
You agree that any dispute that is not related to a Milestone Payment (which must be dealt with in accordance with the Milestone Disputes Policy) arising between you and another User will be handled in accordance with this clause. Yohliwill have full rights and powers to make a determination for all such disputes. Upon receipt of a dispute, Yohli shall have the right to request the Seller and the Buyer to provide documentation in support of their claim or position in relation to the dispute. You agree that Yohli has absolute discretion to accept or reject any document provided. You also acknowledge that Yohli is not a judicial or alternative dispute resolution institution and that we will make the determinations only as an ordinary reasonable person. In addition, we do not warrant that the documents provided by the parties to the dispute will be true, complete or correct and you agree to indemnify and (to the maximum extent permitted by law) hold Yohli and any of our affiliates harmless against any damages or liability you may suffer as a result of any documentation or material subsequently being found to be false or misleading.

In relation to disputes with any other users of the Website, you hereby agree to indemnify Yohli from any and all claims, demands, and damages, actual and consequential, of every kind and nature, known and unknown, that is related to such a dispute, our determinations or the use of the Milestone Dispute Resolution Services for Milestone Payments and/or for Other Disputes.

TheYohli Code of Conduct applies to all the services offered by Yohli, including, but not limited to, the Milestone Dispute Resolution Services. It is agreed by you that you will make every endeavor at fair play and post reasonable and fair demands/offers on your dispute. No conduct relating to threats, blackmail, intimidation or inducement of users to leave positive feedback will be tolerated, in particular any refusal to provide either deliverables or payment in relation to the provision of feedback.
...
<ol start="28">
 	<li><strong> Disputes with Us</strong></li>
</ol>
If a dispute arises between you and Yohli, our goal is to address your concerns immediately and, if we are unable to do so to your satisfaction, to provide you with a means of resolving the dispute quickly. We strongly encourage you to first contact us directly to seek a resolution by using our customer support website or emailing us at <a href="mailto:support@yohli.com">support@yohli.com</a>.

For any claim, Yohli may elect to resolve the dispute in a cost-effective manner through binding non-appearance-based arbitration. If Yohli elects arbitration, such arbitration will be initiated through an established alternative dispute resolution (ADR) provider, which is to be selected by you from a panel of ADR providers that Yohli will provide to you. The ADR provider and the parties must comply with the following rules: a) the arbitration shall be conducted by telephone, online and/or be solely based on written submissions, the specific manner shall be chosen by the party initiating the arbitration; b) the arbitration shall not involve any personal appearance by the parties or witnesses unless otherwise mutually agreed by the parties; and c) any judgment on the award rendered by the arbitrator may be entered in any court of competent jurisdiction.

All claims you bring against Yohli must be resolved in accordance with the terms of this Agreement. All claims filed or brought contrary to this Agreement shall be considered improperly filed and a breach of this Agreement. Should you file a claim contrary to the terms of this Agreement, Yohli may recover its legal fees and costs (including in-house lawyers and paralegals), provided that Yohli has notified you in writing of the improperly filed claim, and you have failed to promptly withdraw the claim.
...
If any proceeding by or against you is commenced under any provision of any bankruptcy or insolvency law, Yohli will be entitled to recover all reasonable costs or expenses (including reasonable legal fees and expenses) incurred in connection with the enforcement of this Agreement.

Yohli 's failure to act with respect to a breach by you or others does not waive our right to act with respect to subsequent or similar breaches.
<ol start="29">
...
<ol start="31">
 	<li><strong> Survival and Release</strong></li>
</ol>
...
<ol start="32">
 	<li><strong> Access and Interference</strong></li>
</ol>
...
<ol>
 	...
 	<li>copy, reproduce, modify, create derivative works from, distribute, or publicly display any content (except for your information) from the websites without the prior express written permission of Yohli and the appropriate third party, as applicable;</li>
...
<ol start="37">
 	<li><strong> No Warranty as to Each User's Purported Identity</strong></li>
</ol>
...
<ol start="38">
 	<li><strong> No Warranty as to Content</strong></li>
</ol>
...
<ol>
 	<li>the Website or any Seller Services or Yohli Services;</li>
 	<li>the accuracy, reliability, availability, veracity, timeliness or content of the Website or any Seller Services or Yohli Services;</li>
 	<li>whether the Website or Seller Services or Yohli Services will be up-to-date, uninterrupted, secure, error-free or non-misleading;</li>
 	<li>whether defects in the Website will be corrected;</li>
 	<li>whether the Website, the Seller Services or the Yohli Services or any data, content or material will be backed up or whether business continuity arrangements are in place in respect of the Website, Seller Services or Yohli Services;</li>
 	<li>any third-party agreements or any guarantee of business gained by you through the Website, Seller Services or Yohli Services or us; or</li>
 	<li>the Website, Seller Services or Yohli Services or infrastructure on which they are based, being error or malicious code free, secure, confidential or performing at any particular standard or having any particular function.</li>
</ol>
...
Legal notices will be served or to the email address you provide to Yohli during the registration process. Notice will be deemed given 24 hours after email is sent, unless the sending party is notified that the email address is invalid or that the email has not been delivered. Alternatively, we may give you legal notice by mail to the address provided by you during the registration process. In such case, notice will be deemed given three days after the date of mailing.

Any notices to Yohli must be given by registered ordinary post (or if posted to or from a place outside Australia, by registered airmail).
<ol start="42">
 	<li><strong> Law and Forum for Legal Disputes</strong></li>
</ol>
This Agreement will be governed in all respects by the laws of Accra Ghana. We encourage you to try and resolve disputes using certified mediation (such as online dispute resolution processes). If a dispute cannot be resolved then you and Yohli irrevocably submit to the non-exclusive jurisdiction of the courts of Accra, Ghana.
<ol start="43">
...
<ul>
 	...
 	<li>API Terms and Conditions</li>
</ul>
Each of these policies may be changed from time to time. Changes take effect when we post them on the Yohli Website. When using particular services on our Website, you are subject to any posted policies or rules applicable to services you use through the Website, which may be posted from time to time. All such policies or rules are incorporated into this User Agreement.
<ol start="48">
 	<li><strong> General</strong></li>
</ol>
Yohli International Pty Limited is located at Level 20, World Square, 680 George Street, Sydney NSW 2000, Australia.

This Agreement contains the entire understanding and agreement between you and Yohli. The following Sections survive any termination of this Agreement: Fees and Services (with respect to fees owed for our services), Release, Content, No Warranty as To Content, Limitation Of Liability, Indemnity, Bar To Action, No Class Actions, Legal Limitations, and Disputes With Us.
<ol start="49">
 	<li><strong> Abusing Yohli</strong></li>
</ol>
Yohli reserves to the greatest extent possible all rights, without limiting any other remedies, to limit, suspend or terminate our service(s) and or user account(s), suspend or ban access to our services, remove any content, and to take any and all technical or legal steps to ban users.
...
<ol>
 	...
 	<li>abuse or poor performance in the Preferred Yohli Program</li>
 	<li>any attempt to use Yohli 's platform or services for any objectionable purpose</li>
 	<li><strong> Feedback</strong></li>
</ol>
If you have any questions about this User Agreement or if you wish to report breaches of this User Agreement, please contact us by using our customer support website or emailing us at <a href="mailto:support@yohli.com">support@yohli.com</a>.
